package com.login.payload.messeges;
...
public class SuccessMessages {
    ...
    public static final String TAKVIM_OLUSTURMA_BASARILI = "Calendar created successfully.";
    public static final String KAYIT_GETIRME_BASARILI = "Records retrieved successfully.";
